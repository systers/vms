...
* You can join our [ AnitaB.org Open Source Zulip Channel](https://anitab-org.zulipchat.com/).  Each active repo has its own channel to direct questions to (for example [#powerup](https://anitab-org.zulipchat.com/#narrow/stream/222537-powerup) or [#portal](https://anitab-org.zulipchat.com/#narrow/stream/222540-portal)).  
...
## General Guidelines
* If you’re just getting started work on an issue labeled “First Timers Only” in any project. Additional resources are available on our [website](https://anitab.org/).
