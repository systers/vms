...
def setUpModule():
    ...
    job_1 = ["Software Developer", "2012-10-22",
             "2012-10-30", "A software job", e1]
    job_2 = ["Systems Administrator", "2012-9-1",
             "2012-10-26", "A systems administrator job", e1]
...
class ShiftTests(unittest.TestCase):
    ...
    def test_calculate_total_report_hours(self):
        ...
        report_list, total_hours = get_report_list(
            duration_list, report_list, total_hours)
...
class ShiftWithVolunteerTest(unittest.TestCase):
    ...
    def setup_test_data(cls):
        ...
        volunteer_3 = ['Ash', "Ash", "Ketchum", "Pallet Town",
                       "Kanto", "Gameboy", "Japan", "23454545", "ash@pikachu.com"]
    ...
    def test_get_volunteer_report(self):
        ...
        report_1 = get_volunteer_report(
            self.v1.id, self.e1.name, self.j1.name, "2012-10-22", "2012-10-30")
        report_2 = get_volunteer_report(
            self.v1.id, self.e1.name, self.j2.name, "2012-9-1", "2012-10-26")
    ...
    def test_get_administrator_report(self):
        ...
        report_1 = get_administrator_report(
            self.v1.first_name, "", "", self.e1.name, self.j1.name, "2012-10-22", "2012-10-30")
        report_2 = get_administrator_report(
            self.v1.first_name, "", "", self.e1.name, self.j2.name, "2012-9-1", "2012-10-26")
        report_3 = get_administrator_report(
...
class ShiftReminderTest(unittest.TestCase):
    ...
    def setup_test_data(cls):
        ...
        shift_2 = [date.today() + timedelta(7), "10:00", "16:00",
                   2, cls.j1]  # one week date
        shift_3 = [date.today() + timedelta(1), "12:00", "18:00",
                   2, cls.j2]  # tomorrow date

        cls.s1 = create_shift_with_details(shift_1)
        cls.s2 = create_shift_with_details(shift_2)
        cls.s3 = create_shift_with_details(shift_3)

        volunteer_1 = ['Jake', "Jake", "Flamoy", "Mario Land", "Nintendo Land",
                       "Nintendo State", "Nintendo Nation", "2374983247", "jake@nintendo.com"]
        volunteer_2 = ['Dora', "Dorothy", "Flamoy", "7 Alpine Street",
                       "Maplegrove", "Wyoming", "USA", "23454545", "dora@test.com"]
    ...
    def test_send_reminder(self):
        ...
        location = ["Test address", "Atlanta",
                    "Georgia", "USA", "Near the south entrance"]
...
class DeleteShiftTest(unittest.TestCase):
    ...
    def setup_test_data(cls):
        ...
        volunteer_1 = ['Aaron', "Aaron", "Turtle", "Mario Land", "Nintendo Land",
                       "Nintendo State", "Nintendo Nation", "2374983247", "aaron@nintendo.com"]
        cls.v1 = create_volunteer_with_details(volunteer_1)
