...
class ShiftDetails(LiveServerTestCase):
    ...
    def navigate_to_shift_details_view(self):
        ...
        self.assertEqual(self.driver.find_element_by_xpath('//table//tbody//tr[1]//td[7]').text,
            'View')
        self.driver.find_element_by_xpath('//table//tbody//tr[1]//td[7]//a').click()
    ...
    def test_view_with_unregistered_volunteers(self):
        ...
        self.assertEqual(self.driver.find_element_by_xpath('//table[1]//tr//td[1]').text,
            'job')
        self.assertEqual(self.driver.find_element_by_xpath('//table[1]//tr//td[3]').text,
            'June 15, 2017')
        self.assertEqual(self.driver.find_element_by_xpath('//table[1]//tr//td[9]').text,
            '6')
        self.assertEqual(self.driver.find_element_by_xpath('//table[1]//tr//td[4]').text,
            '9 a.m.')
        self.assertEqual(self.driver.find_element_by_xpath('//table[1]//tr//td[5]').text,
            '3 p.m.')
    ...
    def test_view_with_only_registered_volunteers(self):
        ...
        volunteer_shift = self.register_volunteer_for_shift_utility(shift,volunteer)
        self.navigate_to_shift_details_view()
        ...
        self.assertEqual(len(self.driver.find_elements_by_xpath('//table[2]//tbody//tr')), 1)
        self.assertEqual(self.driver.find_element_by_xpath('//table[2]//tr//td[1]').text,
            'Michael')
        self.assertEqual(self.driver.find_element_by_xpath('//table[2]//tr//td[9]').text,
    ...
    def test_view_with_logged_hours(self):
        ...
        self.assertEqual(len(self.driver.find_elements_by_xpath('//table[3]//tbody//tr')), 1)
        self.assertEqual(self.driver.find_element_by_xpath('//table[3]//tr//td[1]').text,
            'Michael')
        self.assertEqual(self.driver.find_element_by_xpath('//table[3]//tr//td[4]').text,
            '1 p.m.')
        self.assertEqual(self.driver.find_element_by_xpath('//table[3]//tr//td[5]').text,
            '2 p.m.')
