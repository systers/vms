...
def setUpModule():
    ...
    job_1 = ["Software Developer", "2012-10-22",
             "2012-10-25", "A software job", e1]
    job_2 = ["Systems Administrator", "2012-10-8",
             "2012-10-16", "A systems administrator job", e1]
    job_3 = ["Project Manager", "2012-11-2",
             "2012-11-12", "A management job", e1]
...
class JobWithShiftTests(unittest.TestCase):
    ...
    def setup_test_data(cls):
        ...
        job_4 = ["Information Technologist",
                 "2012-11-2", "2012-12-2", "An IT job", e1]
