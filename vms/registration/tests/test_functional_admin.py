...
class SignUpAdmin(LiveServerTestCase):
    ...
    # validated with regex validations in the code (length, digits and chars,
    # special chars) and those passwords are
    ...
    def test_email_field(self):
        ...
        self.assertNotEqual(page.get_help_blocks(), None)
        self.assertEqual(
            page.get_email_error_text(), "Administrator with this Email already exists."
        )
    ...
    def test_phone_in_different_country(self):
        ...
        self.assertNotEqual(page.get_help_blocks(), None)
        self.assertEqual(page.get_phone_error_text(), page.INVALID_PHONE_FOR_COUNTRY)
    ...
    def test_ajax_load_cities(self):
        response = self.client.post(
            "/registration/load_cities/", {"country": "India", "state": "Uttarakhand"}
        )
        self.assertEqual(response.status_code, 302)
